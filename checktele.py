...
ᤑ (@{username}) done... \n by:  @D_G_C''')
    ...
    {str(eee)}''')
                    if "A wait of" in str(eee):
                        ...
                        await fifthon.send_message(event.chat.id, "ᤑ يوزر متاح يمكن خاصيه \n[KARAR<\>](tg://openmessage?user_id=5967557438)")
            else:
                pass
            trys += 1
        ...
        isclaim.append("off")
        trys = ""
        await event.client.send_message(event.chat_id, "ᤑ انتهى الفحص  \n[KARAR<\>](tg://openmessage?user_id=5967557438)") 
